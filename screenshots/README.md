...
| 파일 | 크기 | 모드 | 내용 |
|------|------|------|------|
| `light.png` | 512×288 (16:9) | Light | v1.8.50 기준: modern disclosure chevron·Style Settings groups·long-token table·report callout·liquid-glass chrome |
...
v1.8.50 기준 mock-up 이미지는 Pillow로 직접 렌더링합니다. 한글은 Windows Malgun Gothic 또는 macOS 시스템 한글 폰트를 사용합니다.
