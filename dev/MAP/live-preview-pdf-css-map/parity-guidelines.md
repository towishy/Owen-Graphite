...
4. Update `docs/v3/research/*fixture.html` or add a fixture when the change has visual risk.
...
- Keep `.cm-embed-block` overflow changes compatible with `dev/MAP/cm6-hit-routing-contract.md`.
