...
FIXTURES = (
    ...
    },
    {
        ...
        "markers": (
            ...
            'data-check="settings-focus-within"',
            'data-check="settings-search-focus-rim"',
            'data-check="modal-close-state"',
            'data-check="style-settings-button-states"',
            'data-check="style-settings-export-modal"',
            'data-check="style-settings-export-rim"',
            'data-check="metadata-focus-state"',
            'data-check="overlay-selection-states"',
            'data-check="menu-selected-state"',
            'data-check="owen-editor-template-preview"',
            'class="owen-editor-command-detail-preview"',
            'data-check="notice-popup-surface"',
            'class="notice-message"',
            'data-check="status-bar-chip-state"',
            'data-check="nav-parent-has-active"',
            ...
            'class="modal-close-button" data-check="modal-close-state" aria-label="Close settings"',
