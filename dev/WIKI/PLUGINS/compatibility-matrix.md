...
| --- | --- | --- | --- |
| Dataview | plugin support or rendered table owner depending on DOM | table layout, sticky header, zebra, number alignment | table fixes leaking to core widgets |
