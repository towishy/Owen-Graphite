...
| --- | --- | --- | --- | --- | --- |
| 2026-07-30 | macOS file explorer scrollbar | `.workspace-leaf-content[data-type="file-explorer"] .nav-files-container` | `src/chrome/37-tabs-file-explorer-search.css` | Obsidian 1.12.7 on macOS CDP: the only vertical overflow candidate had `scrollHeight=1631`, `clientHeight=948`, `overflow-y:auto`; no loaded stylesheet owned a scrollbar rule; a scoped probe resolved `scrollbar-width:none`, `::-webkit-scrollbar { display:none; width:0; height:0 }` while preserving programmatic scroll `0→64px`. `dev/TEMP/runtime-evidence/2026-07-30-chrome-macos-file-explorer-scrollbar.json` | Keep Windows unchanged. Hide only the macOS desktop file explorer native overlay scrollbar from the file explorer owner; preserve scrolling and avoid a broad global scrollbar rule. |
...
| 2026-07-24 | Clean Layered Utility chrome states | `.modal.mod-settings`, `.search-input-container.mod-hotkey`, `.setting-item`, `.workspace-tab-header.is-active`, `.nav-file-title.is-active` | `src/surfaces/23-liquid-glass-core.css`, `src/chrome/30-workspace.css`, `src/chrome/33-settings-controls.css`, `src/chrome/36-floating-ui-glass-system.css`, `src/chrome/37-tabs-file-explorer-search.css` | `dev/TEMP/runtime-evidence/2026-07-24-chrome-clean-layered-ui-state.json` plus CDP fragments and wide/light, narrow/dark fixture screenshots | Use shared neutral workbench tokens for modal, settings, metadata, and selected states; preserve direct owners and keep nested file hover on the title content surface without adding a late repair layer |
