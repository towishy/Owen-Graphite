...
- 하네스: dev/WIKI/DOCS/v3/research/golden-rig/obsidian-harness.html
- Live Preview/PDF 품질 fixture: dev/WIKI/DOCS/v3/research/live-preview-pdf-parity-fixture.html
- PDF 이미지/본문 품질 fixture: dev/WIKI/DOCS/v3/research/pdf-image-body-quality-fixture.html
- 코드 폰트/PDF 품질 fixture: dev/WIKI/DOCS/v3/research/code-font-clarity-fixture.html
- 표/콜아웃 LP-PDF 품질 fixture: dev/WIKI/DOCS/v3/research/table-callout-parity-fixture.html
...
- 베이스라인: dev/WIKI/DOCS/v3/computed-fingerprint-v3.0.0-{light,dark}.json (v3 최초 캡처 원본 — 파일명 그대로 유지)
- 결과: 모두 0 diff
