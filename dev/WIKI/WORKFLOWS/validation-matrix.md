...
| Settings UI / Style Settings | universal checks | `audit_style_settings_contract.py`, `MAP/settings-style-contract.md`, settings pane runtime evidence |
...
Use `dev/scripts/wiki_route.py settings` for either settings pane controls or Style Settings metadata.
