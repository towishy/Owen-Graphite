...
| ---: | --- | --- | --- |
| 0 | Freeze current release baseline | `dev/WIKI/effective-baseline/v3.1.43/*` | bundle hashes, import order, source map, environment recorded |
| 1 | Define source ownership | `dev/WIKI/MAP/owner-registry.json` | every high-risk surface has an owner module |
...
| 6 | Review provenance | `capture_provenance_snapshot.py` + `dev/WIKI/MAP/effective-source-map.json` | matched rules map back to owner modules |
