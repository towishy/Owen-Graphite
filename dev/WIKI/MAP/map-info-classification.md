...
- Selectors: 2545
- Findings: 610
- Finding severity counts: critical=0, high=0, medium=510, low=100, info=0
...
| high | 88 | `src/base/12-reading-content.css` | 144 | 0 | 6 | high-specificity, cm6-hit-routing-sensitive, has-selector, repeated-selector-in-file |
...
| high | 36 | `src/features/43-print-base.css` | 94 | 0 | 0 | high-specificity, cm6-hit-routing-sensitive, repeated-selector-in-file |
| high | 228 | `src/base/13-live-preview.css` | 186 | 0 | 2 | high-specificity, cm6-hit-routing-sensitive, has-selector, repeated-selector-in-file |
| high | 92 | `src/features/41-feature-presets.css` | 310 | 0 | 0 | high-specificity, pdf-header-footer-sensitive, repeated-selector-in-file |
...
| medium | high-specificity | `src/base/12-reading-content.css:612` | specificity=(0, 8, 4) |
| medium | high-specificity | `src/base/12-reading-content.css:633` | specificity=(0, 12, 0) |
| medium | high-specificity | `src/base/12-reading-content.css:718` | specificity=(0, 9, 0) |
| medium | high-specificity | `src/base/12-reading-content.css:747` | specificity=(0, 21, 15) |
| medium | high-specificity | `src/base/12-reading-content.css:780` | specificity=(0, 12, 3) |
| medium | high-specificity | `src/base/12-reading-content.css:839` | specificity=(0, 9, 17) |
| medium | cm6-hit-routing-sensitive | `src/base/12-reading-content.css:880` | CM6 rule declares vertical box or overlay-sensitive properties |
| medium | high-specificity | `src/base/12-reading-content.css:900` | specificity=(0, 8, 3) |
| medium | cm6-hit-routing-sensitive | `src/base/12-reading-content.css:900` | CM6 rule declares vertical box or overlay-sensitive properties |
| medium | cm6-hit-routing-sensitive | `src/base/12-reading-content.css:913` | CM6 rule declares vertical box or overlay-sensitive properties |
| medium | high-specificity | `src/base/12-reading-content.css:931` | specificity=(0, 14, 2) |
| medium | high-specificity | `src/base/12-reading-content.css:994` | specificity=(0, 8, 0) |
| medium | high-specificity | `src/base/12-reading-content.css:1028` | specificity=(0, 12, 3) |
| medium | high-specificity | `src/base/12-reading-content.css:1035` | specificity=(0, 24, 6) |
| medium | high-specificity | `src/base/12-reading-content.css:1042` | specificity=(0, 12, 3) |
| medium | cm6-hit-routing-sensitive | `src/base/12-reading-content.css:1125` | CM6 rule declares vertical box or overlay-sensitive properties |
| medium | cm6-hit-routing-sensitive | `src/base/12-reading-content.css:1133` | CM6 rule declares vertical box or overlay-sensitive properties |
...
| medium | cm6-hit-routing-sensitive | `src/base/13-live-preview.css:352` | CM6 rule declares vertical box or overlay-sensitive properties |
| medium | high-specificity | `src/base/13-live-preview.css:359` | specificity=(0, 16, 4) |
| medium | cm6-hit-routing-sensitive | `src/base/13-live-preview.css:382` | CM6 rule declares vertical box or overlay-sensitive properties |
| medium | cm6-hit-routing-sensitive | `src/base/13-live-preview.css:405` | CM6 rule declares vertical box or overlay-sensitive properties |
| medium | high-specificity | `src/base/13-live-preview.css:412` | specificity=(0, 8, 4) |
| medium | high-specificity | `src/base/13-live-preview.css:447` | specificity=(0, 12, 6) |
| medium | high-specificity | `src/base/13-live-preview.css:474` | specificity=(0, 9, 3) |
| medium | cm6-hit-routing-sensitive | `src/base/13-live-preview.css:546` | CM6 rule declares vertical box or overlay-sensitive properties |
| medium | cm6-hit-routing-sensitive | `src/base/13-live-preview.css:557` | CM6 rule declares vertical box or overlay-sensitive properties |
| medium | cm6-hit-routing-sensitive | `src/base/13-live-preview.css:570` | CM6 rule declares vertical box or overlay-sensitive properties |
| medium | high-specificity | `src/base/13-live-preview.css:596` | specificity=(0, 11, 0) |
| medium | cm6-hit-routing-sensitive | `src/base/13-live-preview.css:606` | CM6 rule declares vertical box or overlay-sensitive properties |
| medium | high-specificity | `src/base/13-live-preview.css:612` | specificity=(0, 9, 0) |
| medium | high-specificity | `src/base/13-live-preview.css:625` | specificity=(0, 9, 0) |
| medium | cm6-hit-routing-sensitive | `src/base/13-live-preview.css:625` | CM6 rule declares vertical box or overlay-sensitive properties |
...
| medium | high-specificity | `src/base/13-live-preview.css:686` | specificity=(0, 8, 0) |
| medium | cm6-hit-routing-sensitive | `src/base/13-live-preview.css:717` | CM6 rule declares vertical box or overlay-sensitive properties |
| medium | high-specificity | `src/base/13-live-preview.css:748` | specificity=(0, 9, 0) |
| medium | high-specificity | `src/base/13-live-preview.css:753` | specificity=(0, 9, 0) |
...
| medium | cm6-hit-routing-sensitive | `src/base/13-live-preview.css:768` | CM6 rule declares vertical box or overlay-sensitive properties |
| medium | high-specificity | `src/base/13-live-preview.css:779` | specificity=(0, 24, 0) |
| medium | high-specificity | `src/base/13-live-preview.css:798` | specificity=(0, 12, 0) |
| medium | high-specificity | `src/base/13-live-preview.css:808` | specificity=(0, 15, 0) |
| medium | high-specificity | `src/base/13-live-preview.css:813` | specificity=(0, 15, 0) |
| medium | high-specificity | `src/base/13-live-preview.css:834` | specificity=(0, 12, 0) |
| medium | cm6-hit-routing-sensitive | `src/base/13-live-preview.css:834` | CM6 rule declares vertical box or overlay-sensitive properties |
| medium | cm6-hit-routing-sensitive | `src/base/13-live-preview.css:841` | CM6 rule declares vertical box or overlay-sensitive properties |
