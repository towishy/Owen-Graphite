...
- Reserved no-match selector parts: 456
- State interaction backlog: 383
...
| --- | ---: | ---: | ---: | --- | --- |
| `src/surfaces/23-liquid-glass-core.css` | 53 | 53 | 129 | captured; runtime-reserved (`dev/TEMP/runtime-evidence/2026-05-25-chrome-surfaces-23-liquid-glass-core.json`) | `.\.venv\Scripts\python.exe dev\scripts\new_runtime_evidence.py --surface chrome --name surfaces-23-liquid-glass-core --state hovered --owner src/surfaces/23-liquid-glass-core.css` |
...
| `src/chrome/35-editing-menu-tooltip-glass.css` | 45 | 45 | 100 | captured; runtime-reserved (`dev/TEMP/runtime-evidence/2026-07-24-chrome-right-sidebar-bottom-frame.json`) | `.\.venv\Scripts\python.exe dev\scripts\new_runtime_evidence.py --surface chrome --name chrome-35-editing-menu-tooltip-glass --state hovered --owner src/chrome/35-editing-menu-tooltip-glass.css` |
| `src/chrome/33-settings-controls.css` | 40 | 40 | 133 | captured; runtime-reserved (`dev/TEMP/runtime-evidence/2026-05-25-chrome-settings-live-preview-runtime-validation.json`) | `.\.venv\Scripts\python.exe dev\scripts\new_runtime_evidence.py --surface chrome --name chrome-33-settings-controls --state hovered --owner src/chrome/33-settings-controls.css` |
