...
- Source modules: 26
- Source CSS lines: 18492
- Parsed CSS rules: 2424
- Selector parts: 3817
...
- `overlay-search`: 275 rules
- `print-pdf`: 467 rules
- `reading-rendered`: 1108 rules
- `table`: 1108 rules
- `workspace-chrome`: 588 rules
...
| ---: | --- | --- | ---: | --- | --- | --- |
| 1 | `src/features/40-style-settings.css` | 45-818 | 781 | style-settings-contract | metadata/tokens | after `None`; before `src/tokens/00-light-tokens.css` |
...
| 16 | `src/chrome/33-settings-controls.css` | 9335-9764 | 439 | settings-controls | overlay-search:51, table:68 | after `src/chrome/32-overlay-popover-dataview.css`; before `src/plugins/60-canvas-graph-link-panes.css` |
...
| 23 | `src/chrome/37-tabs-file-explorer-search.css` | 15152-16079 | 971 | workspace-chrome | overlay-search:10, table:142, workspace-chrome:187 | after `src/chrome/36-floating-ui-glass-system.css`; before `src/themes/51-accessibility-motion-contrast.css` |
...
| `src/chrome/33-settings-controls.css` | 68 | 0 | 0 | 0 |
