...
- Source modules: 26
- Source CSS lines: 18498
- Parsed CSS rules: 2415
- Selector parts: 3808
...
| 23 | `src/chrome/37-tabs-file-explorer-search.css` | 15152-16079 | 976 | workspace-chrome | overlay-search:10, table:143, workspace-chrome:185 | after `src/chrome/36-floating-ui-glass-system.css`; before `src/themes/51-accessibility-motion-contrast.css` |
