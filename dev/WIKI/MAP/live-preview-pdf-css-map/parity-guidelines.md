...
7. CSS compatibility budget is 21,100 lines and 1,040,000 bytes after the 2026-07-25 direct-owner settings pass aligned eight Obsidian core tabs plus Owen Graphite, Owen Editor, and Owen Exporter with Owen Mermaid's grouped settings cards. The gate's normalized UTF-8 metric is 20,962 lines and 1,027,596 bytes, retaining limited headroom; raw aqua, `!important`, `@layer`, and print compatibility budgets remain unchanged.
