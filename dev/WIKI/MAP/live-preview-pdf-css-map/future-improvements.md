...
3. Expand visual fixture contracts.
   - Keep `dev/WIKI/DOCS/v3/research/code-font-clarity-fixture.html` covering both `.token.*` and `.cm-*` syntax spans.
   - Implemented: `dev/WIKI/DOCS/v3/research/table-callout-parity-fixture.html` covers LP markdown table widget, LP HTML embed table, Reading View, and PDF table/callout paths.
...
4. Generate a selector map artifact.
   - Extend current MAP tooling to emit `dev/WIKI/MAP/live-preview-pdf-css-map/generated-selector-index.json`.
...
2. Add per-feature parity notes to `dev/WIKI/DOCS/v3/golden-image-scenarios.md`.
