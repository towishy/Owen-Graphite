...
| **버전** | `2.13.0` (Obsidian 1.6.0+ · 현 베이스라인) |
...
현 베이스라인은 **v2.13.0**입니다. 베이스라인 이후 변경만 요약하며, 이전 이력은 [CHANGELOG.md](CHANGELOG.md)에서 확인할 수 있습니다.
...
| **v2.10.0** | 12 Improvements Pack — Quick Switcher · Notice · Popover · Outline · Tag pill · Diff · Selection · 링크 hover |
