...
[![Style Settings](https://img.shields.io/badge/Style%20Settings-33%20options-0d9488?style=flat-square)](#style-settings-전체-옵션-목록)
...
| **모바일** | ✅ Desktop & Mobile |
| **버전** | `2.9.4` (Obsidian 1.6.0+, baseline since v2.6.2) |
...
2. [Style Settings](https://github.com/mgmeyers/obsidian-style-settings) 플러그인을 설치하면 33개 옵션을 UI에서 조정할 수 있습니다.
...
Style Settings UI는 `읽기와 본문`, `표와 코드`, `보고서와 PDF`, `워크스페이스와 접근성`, `PDF 첫 페이지 헤더` 구획으로 나뉘어 긴 옵션 목록을 빠르게 훑을 수 있습니다. 실제 조정 가능한 옵션 수는 v2.9.0부터 33개 (&quot;본문 색상 코드 옷 swatch 인디케이터&quot; 추가)입니다.
