...
- `v3-rewrite`가 완성되면 `main`에 머지하되, manifest version을 `3.0.0`으로 점프 (이후 v3.0.1 → v3.0.x → v3.1.x 체인이 이어짐, 현재 안정 릴리즈 = v3.1.36).
...
- [release-plan.md](release-plan.md) — v3 릴리즈 기록·툴체인·절차 (현재 안정 v3.1.36)
