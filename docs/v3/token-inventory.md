...
| `--ogd-pdf-header-value` | PDF header/footer marginalia | `""` | `—` | 2 | 1 |
| `--ogd-pdf-label-letter-spacing` | PDF header/footer marginalia | `1.2px` | `—` | 5 | 3 |
| `--ogd-pdf-label-line-height` | PDF header/footer marginalia | `1.2` | `—` | 5 | 1 |
| `--ogd-pdf-label-radius` | PDF header/footer marginalia | `4px` | `—` | 4 | 2 |
| `--ogd-pdf-marginalia-accent` | PDF header/footer marginalia | `#475569` | `#cbd5e1` | 7 | 3 |
